  ...
  return (
    <div className="space-y-5">
      <header>
        ...
        <p className="text-sm text-muted-foreground mt-1">{t("fruitsDesc")}</p>
      </header>
      ...
      <div className="flex gap-2">
        ...
        >
          <Apple className="h-3.5 w-3.5" /> {t("fruits")}
        </Link>
        <Link
          to="/legumes"
        ...
        >
          <Carrot className="h-3.5 w-3.5" /> {t("vegetables")} <Arrow className="h-3 w-3" />
        </Link>
      </div>
